...
public class SpriteStore {
	...
	// one instance of this class will exist, accessed by Game.java
	private static SpriteStore single = new SpriteStore();
	private HashMap sprites = new HashMap(); // key, value pairs that stores the three sprites (alien, ship, shot)
	...
	public Sprite getSprite(String ref) {
		// if the sprite is already in the HashMap then return it
